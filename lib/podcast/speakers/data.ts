...
export const data: SpeakerDto[] = [
  {
    ...
    firstName: "Treasure",
    surname: "Uvietobore",
    displayName: "Treasure U.",
    email: "uvietoboretreasure@gmail.com",
    tel: "+2348157002782",
    occupation: "Software Engineer",
    bio: "Technical Rep, Binx AI",
    website: "usebinx.com",
    location: { city: "Lagos" },
    socials: {
      x: "@treasure_devops",
      in: "treasure-uvietobore",
    },
  },
  {
    id: 22,
    avatar: "/uploads/podcast/avatar-nolaide.jpg",
    firstName: "Naheem",
    surname: "Olaide",
    displayName: "Naheem O.",
    email: "appdever01@gmail.com",
    tel: "",
    occupation: "Software Engineer",
    bio: "Founder/CEO, Binx AI",
    website: "usebinx.com",
    location: {
      city: "Lagos",
    },
    socials: { x: "@naheem__x", in: "naheemolaide" },
  },
  {
    id: 21,
