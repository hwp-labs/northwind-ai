...
export const classNames = {
  ...
  heroGradient2: "bg-gradient-to-r from-blue-300 via-purple-400 to-rose-400",
  glass: `
  border-white/10 
  bg-gradient-to-br 
  from-white/10 
...
const CtaBtn = ({ children }: PropsWithChildren) => (
  <button
    className={clsx(
      "flex-row-cs gap-1.5 rounded-full px-5 py-2.5 text-xs font-semibold",
      classNames.whiteGradient,
      classNames.brandText,
    )}
  >
    <IconWorldUpload size={16} /> {children || APP_PODCAST.domain}
  </button>
);
